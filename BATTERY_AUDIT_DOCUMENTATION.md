...
curl -X POST https://operator-hub-3.preview.emergentagent.com/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"admin","password":"Nura@1234$"}'

# Call the audit endpoint
curl -X GET https://operator-hub-3.preview.emergentagent.com/api/montra-vehicle/battery-audit \
