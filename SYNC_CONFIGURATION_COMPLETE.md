...
**URL**: `https://driver-hub-46.preview.emergentagent.com/api/driver-onboarding/webhook/sync-from-sheets`
...
```javascript
const APP_WEBHOOK_URL = 'https://driver-hub-46.preview.emergentagent.com/api/driver-onboarding/webhook/sync-from-sheets';
...
- **Nura Pulse App**: https://driver-hub-46.preview.emergentagent.com
