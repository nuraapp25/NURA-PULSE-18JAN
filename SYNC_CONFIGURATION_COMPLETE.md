...
**URL**: `https://leadtracker-39.preview.emergentagent.com/api/driver-onboarding/webhook/sync-from-sheets`
...
```javascript
const APP_WEBHOOK_URL = 'https://leadtracker-39.preview.emergentagent.com/api/driver-onboarding/webhook/sync-from-sheets';
...
- **Nura Pulse App**: https://leadtracker-39.preview.emergentagent.com
