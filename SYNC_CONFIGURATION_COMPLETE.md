...
**URL**: `https://nura-operations.preview.emergentagent.com/api/driver-onboarding/webhook/sync-from-sheets`
...
```javascript
const APP_WEBHOOK_URL = 'https://nura-operations.preview.emergentagent.com/api/driver-onboarding/webhook/sync-from-sheets';
...
- **Nura Pulse App**: https://nura-operations.preview.emergentagent.com
