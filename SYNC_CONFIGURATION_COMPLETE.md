...
**URL**: `https://driver-docs-2.preview.emergentagent.com/api/driver-onboarding/webhook/sync-from-sheets`
...
```javascript
const APP_WEBHOOK_URL = 'https://driver-docs-2.preview.emergentagent.com/api/driver-onboarding/webhook/sync-from-sheets';
...
- **Nura Pulse App**: https://driver-docs-2.preview.emergentagent.com
