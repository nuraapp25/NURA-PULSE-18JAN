...
**URL**: `https://hotspot-manager-10.preview.emergentagent.com/api/driver-onboarding/webhook/sync-from-sheets`
...
```javascript
const APP_WEBHOOK_URL = 'https://hotspot-manager-10.preview.emergentagent.com/api/driver-onboarding/webhook/sync-from-sheets';
...
- **Nura Pulse App**: https://hotspot-manager-10.preview.emergentagent.com
