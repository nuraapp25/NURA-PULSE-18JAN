...
import { Home, FileText, Car, Phone, BarChart3, FolderOpen, Settings, Users, Moon, Sun, Menu, X, ChevronDown, Folder, Image, Receipt, Activity, MapPin, QrCode, Navigation, ClipboardList, PieChart, Zap, Database, CalendarDays, Package, Hexagon } from "lucide-react";
...
const Dashboard = () => {
  ...
  const manageItems = [
    { name: "Manage Database", icon: Database, path: "/dashboard/manage-database", roles: ["master_admin", "admin"] },
  ...
  return (
    <div className="h-screen flex bg-gray-50 dark:bg-gray-900 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        {/* Header */}
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 z-40 flex-shrink-0">
