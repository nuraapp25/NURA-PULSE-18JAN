...
import { Home, FileText, Car, Phone, BarChart3, FolderOpen, Settings, Users, Moon, Sun, Menu, X, ChevronDown } from "lucide-react";
...
const Dashboard = () => {
  ...
  const apps = [
    ...
    { name: "Telecaller Queue Manager", icon: Phone, path: "/dashboard/telecaller-queue" },
