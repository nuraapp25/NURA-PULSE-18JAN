...
import { Home, FileText, Car, Phone, BarChart3, FolderOpen, Settings, Users, Moon, Sun, Menu, X, ChevronDown, Folder, Image, Receipt, Activity, MapPin } from "lucide-react";
...
const Dashboard = () => {
  ...
  const allApps = [
    ...
    // Temporarily disabled - { name: "Hotspot Planning", icon: MapPin, path: "/dashboard/hotspot-planning", roles: ["master_admin", "admin", "standard"] },
  ];
