    ...
    <div className="space-y-6" data-testid="driver-onboarding-page">
      ...
      <Dialog open={performanceDialogOpen} onOpenChange={setPerformanceDialogOpen}>
        <DialogContent className="dark:bg-gray-800 max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="dark:text-white">Telecaller Performance Dashboard</DialogTitle>
            <DialogDescription className="dark:text-gray-400">
              Track performance metrics and lead conversion by telecaller
            </DialogDescription>
          </DialogHeader>
          ...
          {performanceData && (
            <div className="space-y-6 mt-4">
              {/* Overall Stats */}
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Overall Statistics</h3>
                <div className="grid grid-cols-4 gap-4">
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Total Leads</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">
                      {performanceData.overall.total_leads}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Contacted</p>
                    <p className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">
                      {performanceData.overall.total_contacted}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Onboarded</p>
                    <p className="text-2xl font-bold text-green-600 dark:text-green-400">
                      {performanceData.overall.total_onboarded}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Conversion Rate</p>
                    <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">
                      {performanceData.overall.conversion_rate}%
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Performance by Telecaller</h3>
                {performanceData.telecallers.map((telecaller, index) => (
                  <div key={index} className="p-4 bg-gray-50 dark:bg-gray-900/20 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between mb-3">
                      <h4 className="font-semibold text-gray-900 dark:text-white">{telecaller.name}</h4>
                      <span className={`px-3 py-1 rounded text-sm font-medium ${
                        telecaller.conversion_rate >= 50 ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' :
                        telecaller.conversion_rate >= 25 ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400' :
                        'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'
                      }`}>
                        {telecaller.conversion_rate}% Conversion
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-5 gap-3">
                      <div>
                        ...
                        <p className="text-lg font-semibold text-gray-900 dark:text-white">{telecaller.total_leads}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-600 dark:text-gray-400">Contacted</p>
                        <p className="text-lg font-semibold text-yellow-600 dark:text-yellow-400">{telecaller.contacted}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-600 dark:text-gray-400">Qualified</p>
                        <p className="text-lg font-semibold text-blue-600 dark:text-blue-400">{telecaller.qualified}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-600 dark:text-gray-400">Onboarded</p>
                        <p className="text-lg font-semibold text-green-600 dark:text-green-400">{telecaller.onboarded}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-600 dark:text-gray-400">Rejected</p>
                        <p className="text-lg font-semibold text-red-600 dark:text-red-400">{telecaller.rejected}</p>
                      </div>
                    </div>

                    {/* Stage Breakdown */}
                    <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-600">
                      <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">Lead Stages</p>
                      <div className="flex space-x-4">
                        <div className="text-center">
                          <p className="text-sm font-medium text-gray-900 dark:text-white">{telecaller.stages.new}</p>
                          <p className="text-xs text-gray-500">New</p>
                        </div>
                        <div className="text-center">
                          <p className="text-sm font-medium text-gray-900 dark:text-white">{telecaller.stages.contacted}</p>
                          <p className="text-xs text-gray-500">Contacted</p>
                        </div>
                        <div className="text-center">
                          <p className="text-sm font-medium text-gray-900 dark:text-white">{telecaller.stages.qualified}</p>
                          <p className="text-xs text-gray-500">Qualified</p>
                        </div>
                        <div className="text-center">
                          <p className="text-sm font-medium text-gray-900 dark:text-white">{telecaller.stages.in_progress}</p>
