...
import { Check, ChevronDown, Upload, FileText, Copy, Download, FileSpreadsheet, Trash2, Clock, Edit, ExternalLink, RefreshCw, AlertCircle } from "lucide-react";
  ...
  if (currentView === "folder-selection") {
    ...
    return (
      <div className="space-y-6" data-testid="payment-reconciliation-page">
        ...
        {/* Create Folder Dialog - Folder Selection View */}
