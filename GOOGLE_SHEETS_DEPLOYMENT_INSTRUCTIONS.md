...
const CONFIG = {
  ...
  BACKEND_URL: 'YOUR_BACKEND_URL_HERE' // Replace with: https://leadonboard.preview.emergentagent.com/api
};
```
...
const CONFIG = {
  ...
  BACKEND_URL: 'https://leadonboard.preview.emergentagent.com/api'
};
```
