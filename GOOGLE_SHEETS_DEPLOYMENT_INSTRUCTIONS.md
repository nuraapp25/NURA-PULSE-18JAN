...
const CONFIG = {
  ...
  BACKEND_URL: 'YOUR_BACKEND_URL_HERE' // Replace with: https://hotspot-manager-10.preview.emergentagent.com/api
};
```
...
const CONFIG = {
  ...
  BACKEND_URL: 'https://hotspot-manager-10.preview.emergentagent.com/api'
};
```
